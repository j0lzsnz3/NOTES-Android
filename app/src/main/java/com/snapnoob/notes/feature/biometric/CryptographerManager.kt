...
interface CryptographerManager {
...
fun CryptographyManager(): CryptographerManager = CryptographerManagerImpl()

/**
 * To get an instance of this private CryptographyManagerImpl class, use the top-level function
 * fun CryptographyManager(): CryptographyManager = CryptographyManagerImpl()
 */
class CryptographerManagerImpl : CryptographerManager {
    ...
    private fun getOrCreateSecretKey(keyName: String): SecretKey {
        // if the SecretKey already created before then return it, else make it
        ...
        // If you reach here, then SecretKey must generated for the keyName
